<footer id="footer" role="footer" class="cf">
    ...
    <div id="social" class="social-wrap">
        ...
        <a href="https://plus.google.com/collections/featured"><img class="go" src="images/go.png"
                                                                    alt="Google Plus"/></a>
        <a href="https://www.pinterest.com"><img class="pt" src="images/pt.png" alt="Pinterest"/></a>
    </div>
    <a id="menu-btn-footer" href="#" onclick="openNav()"><img class="menu-btn-footer" src="images/menu_button.png"
                                                              alt="Menu"/></a>
